...
import { View, SafeAreaView, TouchableOpacity, Modal, Image, useWindowDimensions } from 'react-native';
    ...
    return (
        <MainView style={{backgroundColor: Color.theme}}>
            ...
            <View style={{alignItems: 'center'}}>
                <View style={{padding: 8, marginBottom: 8, borderRadius: 8, backgroundColor: Color.textInput, justifyContent: 'center', alignItems: 'center', ...shadowStyle}}>
                    <AntDesign size={120} name='qrcode' color={Color.text} />
                    <View style={{position: 'absolute', height: 50, width: 50, borderRadius: 25, backgroundColor: Color.textInput, justifyContent: 'center', alignItems: 'center'}}>
                ...
                <TouchableOpacity onPress={() => setModalVirtual(true)}>
                    <Row>
                        <Col justify='center' size={0.75}>
                            <FontAwesome name='credit-card' color={Color.text} style={{marginTop: 2}} />
                        </Col>
                        <Col align='flex-start' size={8} justify='center'>
                            <Text size={12} type='medium'>Virtual Card</Text>
                        </Col>
            ...
            {user && !user.guest && <Grid style={{backgroundColor: Color.theme, borderTopWidth: 0.5, borderColor: Color.border}}>
                <TouchableOpacity onPress={() => navigation.navigate('ChangeProfile')}>
                    <Row>
                        <Col justify='center' size={0.75}>
                            <FontAwesome name='edit' color={Color.text} style={{marginTop: 2}} />
                        </Col>
                        <Col align='flex-start' size={8} justify='center'>
                            <Text size={12} type='medium'>Ubah Profil</Text>
                        </Col>
                        <Col align='flex-end' size={3.25} justify='center'>
                            <FontAwesome name='angle-right' color={Color.text} size={20} />
                        </Col>
                ...
                <TouchableOpacity onPress={() => navigation.navigate('SettingScreen')}>
                    <Row>
                        <Col size={0.75} justify='center'>
                            <AntDesign name='setting' color={Color.text} style={{marginTop: 2}} />
                        </Col>
                        <Col align='flex-start' size={8} justify='center'>
                            <Text size={12} type='medium'>Setting</Text>
                        </Col>
                        <Col align='flex-end' size={3.25} justify='center'>
                            <FontAwesome name='angle-right' color={Color.text} size={20} />
                        </Col>
            ...
            {user && !user.guest && <Grid style={{backgroundColor: Color.theme, borderTopWidth: 0.5, borderColor: Color.border}}>
                <TouchableOpacity onPress={() => onPressExit()}>
                    <Row>
                        <Col justify='center' size={0.75}>
                            <Ionicons name='exit-outline' color={Color.error} style={{marginTop: 2}} />
                        </Col>
                        <Col align='flex-start' size={8} justify='center'>
                            <Text size={12} type='medium' color={Color.error}>Logout</Text>
                        </Col>
                        <Col align='flex-end' size={3.25} justify='center'>
                            <FontAwesome name='angle-right' color={Color.text} size={20} />
                        </Col>
            ...
            {user && user.guest && <Grid style={{backgroundColor: Color.theme, borderTopWidth: 0.5, borderColor: Color.border}}>
                <TouchableOpacity onPress={() => navigation.navigate('LoginScreen')}>
                    <Row>
                        <Col justify='center' size={0.75}>
                            <Ionicons name='exit-outline' color={Color.info} style={{marginTop: 2}} />
                        </Col>
                        <Col align='flex-start' size={8} justify='center'>
                            <Text size={12} type='medium' color={Color.info}>Login</Text>
                        </Col>
                        <Col align='flex-end' size={3.25} justify='center'>
                            <FontAwesome name='angle-right' color={Color.text} size={20} />
                        </Col>
