...
const DetailArtScreen = ({ navigation, route }) => {
      ...
      >
        <View
          style={{
            width: '100%',
            aspectRatio: 1,
            backgroundColor: index %2 === 0 ? Color.border : Color.primarySoft,
            borderRadius: 16,
          }}
        >
        ...
        >
          <Text align='left' type='medium' numberOfLines={2}>Laughtale on Digital-land on Digital-land on Digital-land</Text>
        </View>
      </View>
    )
  };
  ...
  const renderHeader = () => {
    return (
      ...
      >
        ...
        >
          {Array.isArray(items.img) && items.img.length > 0 ? items.img.map((i, idx) => {
            return (
              <TouchableOpacity
                key={idx}
                // onPress={() => {
        ...
        <Container paddingHorizontal={8} marginTop={8} marginBottom={16}>
          <View>
            <Text
              size={20}
              align='left'
          ...
          <View style={{ flexDirection: 'row', marginTop: 8 }}>
            ...
            <View
              ...
              />
              <Divider width={4} />
              <Text size={10} type='medium'>Museum</Text>
            </View>
          </View>
        </Container>
        ...
        <Container paddingHorizontal={8} marginTop={0}>
          <Text
            align='left'
            type='medium'
            letterSpacing={0.1}
        ...
        {/* <Container padding={8}>
          <View style={{ flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between' }}>
            <Text align='left' size={12} type='medium'>Karya</Text>
          </View>
        </Container> */}
      </View>
    )
...
export default DetailArtScreen;