    ...
    Client.query({query: queryGetCart, variables})
      .then(res => {
        ...
        if (res.data.ecommerceCartList) {
          setCart(
            res.data.ecommerceCartList.totalProducts
              ? res.data.ecommerceCartList.totalProducts
              : 0,
          );
        }
  ...
  const renderItem = ({item}) => (
    <TouchableOpacity
      ...
      <View
        ...
        <Text style={{fontSize: 8, color: Color.border, textAlign: 'left'}}>
          Harga Awal
        </Text>
        <View style={{flexDirection: 'row'}}>
          {/* <Text style={{fontSize: 14, fontWeight: 'bold', color: Color.textInput,}}>Rp.</Text> */}
          <Text
            style={{fontSize: 14, fontWeight: 'bold', color: Color.textInput}}>
      ...
      <View
        ...
        <Text
          ...
          {moment.unix(item.time_end / 1000 - moment().unix()).format('DD') > 0
            ? moment.unix(item.time_end / 1000 - moment().unix()).format('DD') +
              ' Hari '
            : ''}
  ...
  const render = ({item}) => (
    <Pressable
      ...
      <View
        ...
        <Text
          style={{fontSize: 10, color: Color.secondary, marginHorizontal: 3}}>
          {item.review}
        </Text>
        <View
          style={{
  ...
  return (
    <ScrollView style={{backgroundColor: Color.theme}}>
      ...
      <View style={{marginTop: 5}}>
        <Text
          style={{textAlign: 'left', marginHorizontal: 15, fontWeight: 'bold'}}>
        ...
        <Pressable
          ...
          <FlatList
            ...
            horizontal
            data={[
              {image: ImagesPath.BannerPink},
              {image: ImagesPath.bannerlelang},
            ]}
            renderItem={({item}) => (
              <Image
                source={item.image}
      ...
      <Content
        ...
        <Row>
          <TouchableOpacity
            ...
            style={{marginRight: 22, alignItems: 'center'}}>
