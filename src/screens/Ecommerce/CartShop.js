  ...
  return (
    <View style={{ flex: 1, backgroundColor: Color.theme }}>
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
          <View>
                <Row style={{ paddingHorizontal: 16, backgroundColor: Color.white, paddingVertical: 20 }}>
                    <View style={{ justifyContent: 'center' }}>
                        <TouchableOpacity style={{ height: 13, width: 13, marginRight: 16, borderColor: Color.primaryBlack, borderWidth: 1, borderRadius: 2 }}>
                            
                        </TouchableOpacity>
                    </View>
                    <View style={{ height: 56, width: 56, marginRight: 14, backgroundColor: Color.primaryBlack, borderRadius: 8 }} />
                    <Col>
