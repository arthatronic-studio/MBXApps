  ...
  return (
    ...
    style={{backgroundColor: Color.semiwhite}}
      ...
      <ScrollView showsVerticalScrollIndicator={false} style={{ flex: 1 }}>
            <Content style={{ backgroundColor: Color.theme, shadowColor: Color.border, shadowWidth: 5}}>
                ...
                <View style={{ backgroundColor: Color.border, height: 1, marginVertical: 12 }} />
            ...
            <Content style={{ backgroundColor: Color.theme }}>
                ...
                {item.tempData.map((val, id) => (
                    ...
                    <FontAwesome name={'sticky-note-o'} style={{position: 'absolute', paddingVertical: 11, paddingHorizontal: 10}}/>
                    </Row>
                <TouchableOpacity onPress={() => {address.address ? navigation.navigate('ListShipping', {item: {...address, product: item.tempData }}) : alert('Isi alamat terlebih dahulu')}}>
                    <Row style={{ backgroundColor: Color.theme,borderWidth: 1, borderColor: Color.border, alignItems: 'center', padding: 12, marginTop: 10, borderRadius: 8 }}>
