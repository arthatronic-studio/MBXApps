          ...
          <TouchableOpacity
            onPress={() =>
              navigation.navigate('CheckoutScreen', {
                ...
                list: [{name: detail.merchant ? detail.merchant.name : '', profileImg: detail.merchant ? detail.merchant.profileImg : '', alamat: detail.merchant ? detail.merchant.alamat : '', shipping: null, products: [{...detail, qty: 1,quantity: 1, note: ''}]}],
              })
            }
            style={{
              width: '30%',
