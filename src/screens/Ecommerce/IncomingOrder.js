...
function Dikemas() {
  ...
  return (
    <View
      ...
      <View
        style={{flexDirection: 'row', marginVertical: 15, marginHorizontal: 5}}>
        <TouchableOpacity
          style={{
            marginHorizontal: 5,
            backgroundColor: Color.theme,
      ...
      <Pressable
        ...
        <View style={{flexDirection: 'row'}}>
          ...
          <View
            style={{width: '70%', paddingHorizontal: 10, paddingVertical: 2}}>
            <Text style={{fontSize: 11, textAlign: 'left', fontWeight: 'bold'}}>
              Hendra Helinsky
            </Text>
            <Text
              style={{fontSize: 8, textAlign: 'left', color: Color.secondary}}>
              No. Pesanan : 100000012345678
            </Text>
          </View>
          <Text style={{fontSize: 10, marginVertical: 8, color: Color.primary}}>
            Perlu Dikirim
          </Text>
        </View>
        <Divider />
        <View
          style={{width: '99%', height: 1, backgroundColor: Color.border}}
        />
        <Divider />
        <View style={{flexDirection: 'row'}}>
          <Image
        ...
        <View
          ...
          <Text style={{fontSize: 8, textAlign: 'left', paddingVertical: 2}}>
            Catatan Pembeli
          </Text>
          <Text
            style={{
        ...
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          <Text style={{textAlign: 'left', width: '50%', marginHorizontal: 2}}>
            <Text
              ...
              Mohon melakukan pengiriman/pengaturan pengiriman sebelum tanggal
              28 Januari 2022
            </Text>
          </Text>
          <TouchableOpacity
    ...
    <View
      ...
      <Pressable
        ...
        <View style={{flexDirection: 'row'}}>
          <Image source={ImagesPath.avatar4} />
          <View
            style={{width: '78%', paddingHorizontal: 10, paddingVertical: 2}}>
            <Text style={{fontSize: 11, textAlign: 'left', fontWeight: 'bold'}}>
              Hendra Helinsky
            </Text>
            <Text
    ...
    <View
      ...
      <Pressable
        ...
        <View style={{alignItems: 'center'}}>
          <View style={{width: '98%', marginHorizontal: 2}}>
            ...
            <Text
              ...
              Soufflé soufflé lemon drops jelly-o bonbon sweet roll cake cookie.
              Marshmallow jujubes dessert dragée lollipop cake danish wafer
              sweet. Icing carrot cake bear claw bonbon ice cream muffin
              croissant lollipop.
            </Text>
          </View>
        </View>
        <TouchableOpacity
          ...
          <Text
            style={{fontSize: 12, fontWeight: 'bold', color: Color.textInput}}>
            Chat Pembeli
          </Text>
        </TouchableOpacity>
      </Pressable>
