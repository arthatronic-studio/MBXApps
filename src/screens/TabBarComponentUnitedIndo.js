...
const TabBarComponentUnitedIndo = (props) => {
    ...
    const [menus] = useState([        
        ...
        {id: 'not', name: 'Notif', iconName: 'notifications-outline', iconType: 'Ionicons', nav: 'NotificationScreen', ref: useRef(new Animated.Value(0.4)).current, viewRef: useRef(new Animated.Value(1)).current },
...
export default TabBarComponentUnitedIndo;