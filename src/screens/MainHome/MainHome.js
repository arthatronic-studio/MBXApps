...
const sambatanMenus = [
  { id: 6, name: 'Iuran', images: iconIuran, nav: 'OrderListPerProduct', params: { title: 'Iuran', type: 'ACTIVE', productType: 'ALL_SAMBATAN' } },
  ...
  // { id: 5, name: 'Internet', images: iconInternet, nav: '', params: { title: 'Iuran Non-wajib', type: 'ACTIVE', productType: 'SAMBATAN_O' } },
  // { id: 7, name: 'Semua', images: iconSemua, nav: '', params: { title: 'Iuran Non-wajib', type: 'ACTIVE', productType: 'SAMBATAN_O' } },
];
...
const MainHome = ({ navigation, route }) => {
  ...
  const getIconMenu = (iconType, iconName, isRouteActive) => {
    switch(iconType) {
        case 'Ionicons': 
            return <Ionicons name={iconName} size={50} color={isRouteActive ? Color.primary : Color.gray} style={{marginBottom: 8}} />
        case 'FontAwesome5':
            return <FontAwesome5 name={iconName} size={50} color={isRouteActive ? Color.primary : Color.gray} style={{marginBottom: 8}} />
    }
  }
  ...
  return (
    <MainView style={{backgroundColor: Color.theme}}>
      <HeaderBig
        ...
        actions={
          <View style={{flexDirection: 'row'}}>
            <TouchableOpacity onPress={() => {}} style={{width: '20%', justifyContent: 'flex-start', alignItems: 'flex-end'}}>
      ...
      >
        <View style={{flexDirection: 'row', width: '100%', alignItems: 'center', paddingHorizontal: 16, paddingVertical: 20}}>
          <Image source={{uri: ''}} style={{width: '14%', aspectRatio: 1, borderRadius: 50, backgroundColor: Color.border}} />
          <View style={{paddingLeft: 16, alignItems: 'flex-start'}}>
            <Text lineHeight={18} letterSpacing={0.45}>Halo,</Text>
            <Text size={18} type='bold' lineHeight={22} letterSpacing={0.45}>{user && !user.guest ? user.firstName + ' ' + user.lastName : 'Tamu'}</Text>
          </View>
        </View>

        <ContentView>
          <BalanceView style={{ ...shadowStyle, backgroundColor: Color.textInput }}>
            <View style={{justifyContent: 'center', alignItems: 'flex-start'}}>
              <Text size={10}>Saldo</Text>
              <Text size={18} type='semibold' style={{marginTop: 2}}>{FormatMoney.getFormattedMoney(vestaAmount)}</Text>
            </View>
            <View style={{flexDirection: 'row', justifyContent: 'center', alignItems: 'flex-end'}}>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center', marginLeft: 16}}>
                <TouchableOpacity
                  style={{aspectRatio: 1, height: 30, borderRadius: 4, backgroundColor: Color.primary, alignItems: 'center', justifyContent: 'center', marginBottom: 4}}
                  onPress={() => isWalletClose ? openVesta() : navigation.navigate('TopUpScreen')}
                >
                  <Ionicons name='add' color={Color.textInput} size={26} style={{marginLeft: 2, marginTop: 2}} />
                </TouchableOpacity>
                <View style={{width: '100%', alignItems: 'center'}}>
                  <Text size={9} type='medium' color={Color.text}>Saldo</Text>
                </View>
              </View>
              ...
              <View style={{justifyContent: 'center', alignItems: 'center', marginLeft: 16}}>
                <TouchableOpacity
                  style={{aspectRatio: 1, height: 30, borderRadius: 4, backgroundColor: Color.primary, alignItems: 'center', justifyContent: 'center', marginBottom: 4}}
                  onPress={() => navigation.navigate('CreatePanicScreen', {
                    title: 'Panic Button',
                    productType: "TRIBES",
                ...
                >
                  <Ionicons name='information' color={Color.textInput} size={22} style={{marginLeft: 2, marginTop: 2}} />
                </TouchableOpacity>
                <View style={{width: '100%', alignItems: 'center'}}>
                  <Text size={9} type='medium' color={Color.text}>Panic!</Text>
                </View>
              </View>
            </View>
          </BalanceView>
        ...
        <ContentView>
          <SambatanMenuView style={{ ...shadowStyle, backgroundColor: Color.textInput }}>
            {sambatanMenus.map((menu, idx) => {
              ...
              return (
                ...
                >
                  <UserIcon>
                    <ImageProperty style={menu.comingsoon && {opacity: 0.3}} resizeMode='contain' source={menu.images} />
                    <Text size={12} style={menu.comingsoon && {opacity: 0.3}}>{menu.name}</Text>
        ...
        >
            {listTampil.map((e, idx) => (
                ...
                >
                    <Image
                        source={{uri: e.image}}
                        style={{height: '100%', width: '100%', resizeMode: 'cover', borderRadius: 8, backgroundColor: Color.borderSoft}}
                        resizeMode='cover'
                    />
                </TouchableOpacity>
            ))}
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, marginTop: 30}}>
            <Text type='bold'>Panic Button</Text>
            <Text onPress={() => navigation.navigate('NewsScreen', { title: 'Panic Button' })} size={12} color={Color.primary}>Lihat Semua <Ionicons name='arrow-forward' size={12} color={Color.primary} /></Text>
        </View>
        <ListNews
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, marginTop: 30}}>
            ...
            <Text onPress={() => navigation.navigate('NewsScreen', { title: 'Postingan Saat Ini' })} size={12} color={Color.primary}>Lihat Semua <Ionicons name='arrow-forward' size={12} color={Color.primary} /></Text>
        </View>
        <ListNews
            data={listTampil}
            horizontal
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16}}>
            ...
            <Text onPress={() => navigation.navigate('PlaceScreen')} size={12} color={Color.primary}>Lihat Semua <Ionicons name='arrow-forward' size={12} color={Color.primary} /></Text>
        </View>
        <ListPlace
            data={listJalanJalan}
            horizontal
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingBottom: 8}}>
            <Text type='bold'>Event Terbaru</Text>
            <Text onPress={() => navigation.navigate('WorkshopScreen')} size={12} color={Color.primary}>Lihat Semua <Ionicons name='arrow-forward' size={12} color={Color.primary} /></Text>
        </View>
        <ListWorkshop
            data={listBelajar}
            horizontal
        ...
        <View style={{width: '100%', flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 16, paddingBottom: 8}}>
            ...
            <Text onPress={() => navigation.navigate('JobScreen')} size={12} color={Color.primary}>Lihat Semua <Ionicons name='arrow-forward' size={12} color={Color.primary} /></Text>
        </View>
        <ListJob
            data={listKerja}
            horizontal={false}
