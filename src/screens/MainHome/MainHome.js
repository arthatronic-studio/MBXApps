		...
		>
						...
						>
							<View style={{ backgroundColor: '#fff' }}>
								...
								>
									...
									>
										<Image source={ImagesPath.icClose} style={{ width: 16, height: 16 }} />
									</TouchableOpacity>
									<View style={{ flexDirection: 'row' }}>
										...
										<View>
											<View style={{ width: '86%' }}>
												<Text align="left" size={14} style={{ fontWeight: 'bold' }}>
											...
											<View style={{ marginTop: 16 }}>
												<Text align="left" size={11} style={{ fontWeight: 'bold' }}>
													Sinopsis
												</Text>
											</View>
											<View style={{ width: '80%' }}>
												<Text align="left" size={10} numberOfLines={4}>
													Cookie toffee pie cupcake sesame snaps. Cupcake cupcake soufflé
													gummies croissant jelly beans candy canes fruitcake. Dessert cotton
													candy tart donut tiramisu cookie dragée wafer marzipan.
												</Text>
											</View>
										</View>
									</View>
          ...
          /> */}
					...
					<View style={{ marginBottom: 40 }}>
						...
						<Divider height={8} />
						<CarouselView delay={5000} showIndicator style={{ width, aspectRatio: 21 / 9 }}>
							{[ 0 ].map((e, idx) => {
								return (
									<View
										key={idx}
                    ...
                    <Image source={item.image} style={{ marginHorizontal: 15 }} />
						...
						<View>
							<TouchableOpacity onPress={() => navigation.navigate('Ebook')}>
								<Text style={{ color: Color.info, paddingVertical: 20, textAlign: 'right', paddingHorizontal: 20 }}>
									Selengkapnya
								</Text>
							</TouchableOpacity>
						</View>
				...
				<View style={{ width: '90%', aspectRatio: 9 / 16, alignSelf: 'center' }}>
					...
					>
						...
						>
							...
							>
								<Image source={ImagesPath.icClose} style={{ width: 20, height: 20 }} />
							</TouchableOpacity>
						</ImageBackground>
					</TouchableOpacity>
				</View>
