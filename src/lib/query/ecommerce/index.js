...
export const queryUpdateItemCart = gql`
  mutation ecommerceCartUpdate($productId: Int!, $quantity: Int!) {
    ecommerceCartUpdate(productId: $productId, quantity: $quantity) {
      id
    }
  }
`;
...
export const queryGetProduct = gql`
  query ($page: Int!, $itemPerPage: Int!) {
    ecommerceProductList(page: $page, itemPerPage: $itemPerPage) {
      id
      name
      categoryId
      description
