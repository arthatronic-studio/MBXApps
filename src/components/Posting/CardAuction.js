                ...
                >
                    <View 
                        ...
                        <View style={{flexDirection: 'column', justifyContent: 'space-between', alignItems:'flex-start' }}>
                            <View
                            style={{ flexDirection: 'row', width: '100%', justifyContent: 'flex-start', alignItems: 'flex-start' }}>
                                <Text size={14} color={Color.textInput} type='bold' align='left' numberOfLines={2}>{item.productName}</Text>
                            </View>
                            <View
