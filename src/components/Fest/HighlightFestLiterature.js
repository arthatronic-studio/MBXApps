...
const HighlightFestLiterature = (props) => {
    const {
        userProfileId,
        productCategory,
        name,
...
HighlightFestLiterature.propTypes = propTypes;
HighlightFestLiterature.defaultProps = defaultProps;
export default HighlightFestLiterature;