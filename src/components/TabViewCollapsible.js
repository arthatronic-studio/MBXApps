...
const TabViewCollapsible = ({ ListHeaderComponent, HeaderHeight }) => {
  ...
  const renderHeader = () => {
    ...
    return (
      <Animated.View style={[styles.header, {height: HeaderHeight, transform: [{translateY: y}]}]}>
        {ListHeaderComponent}
      </Animated.View>
    );
  };
...
export default TabViewCollapsible;