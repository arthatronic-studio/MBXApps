                    ...
                    >
                        ...
                        >
                            <Container width='100%' height='35%' paddingHorizontal={12} paddingVertical={16} color={Color.overflow} style={{ borderBottomLeftRadius: 16, borderBottomRightRadius: 16 }}>
                                <Text size={17} color={Color.textInput} align='left' type='bold' numberOfLines={1}>Titik temu Coffee</Text>
                                <Divider height={6} />
                                <Text size={10} color={Color.textInput} align='left' type='medium' numberOfLines={1}>Cafe</Text>
                            </Container>
                        </ImageBackground>
                    </TouchableOpacity>
                </View>
